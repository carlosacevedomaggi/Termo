...
function LocationStep(param) {
    let { partners, value, onChange, errors, onErrorsChange, onComplete } = param;
    _s();
    ...
    const nearestPartners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LocationStep.useMemo[nearestPartners]": ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$maps$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortPartnersByDistance"])(partners, value.customerLocation.lat, value.customerLocation.lng).slice(0, 5);
        }
    }["LocationStep.useMemo[nearestPartners]"], [
        partners,
        value.customerLocation
    ...
    const selectedPartner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LocationStep.useMemo[selectedPartner]": ()=>{
            var _partners_find;
            return (_partners_find = partners.find({
                "LocationStep.useMemo[selectedPartner]": (partner)=>partner.id === value.selectedPartnerId
            }["LocationStep.useMemo[selectedPartner]"])) !== null && _partners_find !== void 0 ? _partners_find : null;
        }
    }["LocationStep.useMemo[selectedPartner]"], [
        partners,
    ...
    const performSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LocationStep.useMemo[performSearch]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2e$debounce$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
    ...
    const handleLocationChange = (location)=>{
        var _sortPartnersByDistance_;
        var _sortPartnersByDistance__id;
        onChange({
            ...value,
            customerLocation: location,
            selectedPartnerId: (_sortPartnersByDistance__id = (_sortPartnersByDistance_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$maps$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortPartnersByDistance"])(partners, location.lat, location.lng)[0]) === null || _sortPartnersByDistance_ === void 0 ? void 0 : _sortPartnersByDistance_.id) !== null && _sortPartnersByDistance__id !== void 0 ? _sortPartnersByDistance__id : null
        });
        onErrorsChange({
            ...errors,
            customerLocation: ""
...
function CheckoutPage() {
    ...
    const distributors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CheckoutPage.useMemo[distributors]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$partners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartnersByType"])("distributor")
    }["CheckoutPage.useMemo[distributors]"], []);
    ...
    async function fetchDirections(customerLat, customerLng, partner) {
        try {
            ...
            return {
                ...
                minutesCapped,
                fee,
                distanceMeters: (_data_distance = data.distance) !== null && _data_distance !== void 0 ? _data_distance : null,
                source: "ors"
            };
        } catch (error) {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StepActions, {
                                        ...
                                        onNext: async ()=>{
                                            ...
                                            try {
                                                var _locationValues_customerLocation, _getPartnerById, _getPartnerById1, _getPartnerById2, _getPartnerById3, _getPartnerById4, _getPartnerById5;
                                                var _locationValues_customerLocation_label, _getPartnerById_name, _getPartnerById_address, _deliveryInfo_minutes, _getPartnerById_lat, _getPartnerById_lng, _getPartnerById_lat1, _getPartnerById_lng1;
                                                const payload = {
                                                    ...
                                                    metadata: {
                                                        ...
                                                        customerCoordinates: locationValues.customerLocation,
                                                        partnerCoordinates: locationValues.selectedPartnerId ? {
                                                            lat: (_getPartnerById_lat1 = (_getPartnerById4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$partners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartnerById"])(locationValues.selectedPartnerId)) === null || _getPartnerById4 === void 0 ? void 0 : _getPartnerById4.lat) !== null && _getPartnerById_lat1 !== void 0 ? _getPartnerById_lat1 : null,
                                                            lng: (_getPartnerById_lng1 = (_getPartnerById5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$partners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartnerById"])(locationValues.selectedPartnerId)) === null || _getPartnerById5 === void 0 ? void 0 : _getPartnerById5.lng) !== null && _getPartnerById_lng1 !== void 0 ? _getPartnerById_lng1 : null
                                                        } : null
                                                    }
                                                };
...
_s(CheckoutPage, "hlaH+KFQKagOtgPZYB+7fjZWXiA=", false, function() {
    return [
        ...
        children: [
            ...
            deliveryInfo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    ". Distancia aproximada: ",
                    deliveryInfo.distanceMeters ? "".concat((deliveryInfo.distanceMeters / 1000).toFixed(1), " km") : "N/D",
                    "."
                ]
            }, void 0, true, {
                fileName: "[project]/src/app/checkout/page.tsx",
...
//# sourceMappingURL=src_d105a43b._.js.map