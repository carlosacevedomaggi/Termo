...
"[project]/src/lib/product-data.ts [app-client] (ecmascript)", (() => {{

throw new Error("An error occurred while generating the chunk item [project]/src/lib/product-data.ts [app-client] (ecmascript)\n\nCaused by:\n- the chunking context (unknown) does not support external modules (request: node:fs)\n\nDebug info:\n- An error occurred while generating the chunk item [project]/src/lib/product-data.ts [app-client] (ecmascript)\n- Execution of *EcmascriptChunkItemContent::module_factory failed\n- Execution of <ModuleChunkItem as EcmascriptChunkItem>::content_with_async_module_info failed\n- Execution of *EcmascriptChunkItemContent::new failed\n- Execution of EcmascriptModuleContent::new failed\n- the chunking context (unknown) does not support external modules (request: node:fs)");
...
function ProductsPage() {
    ...
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])({
        "ProductsPage.useCartStore[addToCart]": (state)=>state.addItem
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsPage.useEffect": ()=>{
            setCategories((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductCategories"])());
        }
    }["ProductsPage.useEffect"], []);
...
_s(ProductsPage, "4kB2gVB+4Gn2YvXgu5TV2YCuvGU=", false, function() {
    return [
...
//# sourceMappingURL=_345f4b21._.js.map