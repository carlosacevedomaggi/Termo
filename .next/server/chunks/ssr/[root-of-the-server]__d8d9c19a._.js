...
"[project]/src/lib/product-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function loadCategoryWithProducts(config) {
    ...
    if (config.mode === "single") {
        ...
        const slug = slugify(meta.name || config.dir);
        products.push({
            slug,
            meta,
            images
        ...
        for (const entry of entries){
            ...
            const slug = slugify(meta.name || entry.name);
            products.push({
                slug,
                meta,
                images
...
function parseMetadata(filePath) {
    try {
        ...
        const quantityValue = parseInt(lines.pop().replace(/[^0-9]/g, ""), 10) || 0;
        const maybeQuantityLabel = lines.pop();
        if (!maybeQuantityLabel || !/cantidad/i.test(maybeQuantityLabel)) {
            // If label is missing, push back for description
            lines.push(maybeQuantityLabel ?? "");
        }
        const priceLine = lines.pop() ?? "";
        const priceMatch = priceLine.match(/\$\s*([0-9]+(?:[.,][0-9]{1,2})?)/);
        const price = priceMatch ? Number(priceMatch[1].replace(/\./g, "").replace(/,/g, ".")) : 0;
        const availabilityLine = lines.pop() ?? "";
        const availability = parseInt(availabilityLine.replace(/^Disponibilidad:\s*/i, "").replace(/[^0-9]/g, ""), 10) || 0;
        const modelLine = lines.pop() ?? "";
        const model = modelLine.replace(/^Modelo:\s*/i, "").trim();
        const manufacturerLine = lines.pop() ?? "";
        const manufacturer = manufacturerLine.replace(/^Fabricante:\s*/i, "").trim();
        const name = (lines.pop() ?? "").trim();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/product-data.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ProductsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setCategories((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductCategories"])());
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8d9c19a._.js.map