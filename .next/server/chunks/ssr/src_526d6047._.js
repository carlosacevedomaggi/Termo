...
const distributors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$partners$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPartnersByType"])("distributor");
function LocationStep({ value, onChange, errors, onErrorsChange, onComplete }) {
    ...
    const nearestPartners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$maps$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sortPartnersByDistance"])(distributors, value.customerLocation.lat, value.customerLocation.lng).slice(0, 5);
    }, [
        value.customerLocation
    ]);
    const selectedPartner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return distributors.find((partner)=>partner.id === value.selectedPartnerId) ?? null;
    }, [
        value.selectedPartnerId
    ]);
    const performSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>debounce(async (query)=>{
            if (!query.trim()) {
                setSearchResults([]);
                return;
            }
    ...
    const handleLocationChange = (location)=>{
        onChange({
            ...
            selectedPartnerId: value.fulfillmentMode === "pickup" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$maps$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sortPartnersByDistance"])(distributors, location.lat, location.lng)[0]?.id ?? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$maps$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sortPartnersByDistance"])(distributors, location.lat, location.lng)[0]?.id ?? null
        });
        onErrorsChange({
            ...errors,
            customerLocation: ""
...
//# sourceMappingURL=src_526d6047._.js.map