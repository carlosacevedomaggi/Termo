export type PartnerLocation = {
  city: string
  businesses: Array<BusinessEntry>
}
...
export const distributorLocations: PartnerLocation[] = [
  {
    city: "Barcelona",
    businesses: [
      {
...
export const serviceLocations: PartnerLocation[] = [
  {
    city: "Barcelona",
    businesses: [
      {
...
export const sections: PartnerSection[] = [
  {
    id: "distributors",
